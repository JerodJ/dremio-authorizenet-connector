...
@SourceType(value = "AuthorizeNetARP", label = "AuthorizeNet",uiConfig = "authorizenet-layout.json")
public class AuthorizeNetConf extends AbstractArpConf<AuthorizeNetConf> {
  private static final String ARP_FILENAME = "arp/implementation/authorizenet-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.authorizenet.AuthorizeNetDriver";
